...
@Controller('sell')
export class RepairTemplatesController {
  constructor(
    private readonly service: RepairTemplatesService,
    private readonly testEmailService: RepairTestEmailService,
    private readonly queueService: RepairEmailQueueService,
  ) {}
  ...
  @Post('templates')
  @Roles(...WRITER_ROLES)
  create(@Body() dto: CreateRepairTemplateDto, @CurrentUser() user: JwtPayload) {

...
import { SuppressionReason } from './schemas/repair-suppression.schema';

@Controller('repair/unsubscribe')
export class RepairUnsubscribeController {
  private readonly logger = new Logger(RepairUnsubscribeController.name);
   ...
   * GET /api/v1/repair/unsubscribe/:token
   *

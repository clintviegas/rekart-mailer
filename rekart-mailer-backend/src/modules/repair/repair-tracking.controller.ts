...
@Controller('repair/track')
export class RepairTrackingController {
  private readonly logger = new Logger(RepairTrackingController.name);
  ...
  /**
   * Open tracking pixel
   * GET /api/v1/repair/track/open/:token
   *
   ...
   * GET /api/v1/repair/track/click/:token?url=<encoded-destination>
   *

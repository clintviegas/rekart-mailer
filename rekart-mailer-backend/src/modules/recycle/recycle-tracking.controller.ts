...
@Controller('recycle/track')
export class RecycleTrackingController {
  private readonly logger = new Logger(RecycleTrackingController.name);
  ...
  /**
   * Open tracking pixel
   * GET /api/v1/recycle/track/open/:token
   *
   ...
   * GET /api/v1/recycle/track/click/:token?url=<encoded-destination>
   *

...
import { JourneyCurrency } from '../schemas/sell-request-journey.schema';
...
export class CreateJourneyDto {
  ...
  @IsEnum(JourneyCurrency, {
    message: `currency must be one of: ${Object.values(JourneyCurrency).join(', ')}`,
  })
  @IsOptional()

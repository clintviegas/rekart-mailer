// ────────────────────────────────────────────────────────────────────────────
//  Recycle workflow live email preview — metadata-driven template engine
...
export const PREVIEW_FALLBACKS: Record<string, string> = {
  ...
  RecycleNotes: "Screen replacement in progress",
  paymentAmount: "17000",
...
export const PREVIEW_TEMPLATES: PreviewTemplate[] = [
  // ── 1. Booking Confirmed ────────────────────────────────────────────────────
  {
    ...
    bodyText: () =>
      `We've received your Recycle request and our team is reviewing it. You'll hear from us shortly to schedule a convenient pickup.`,
    blocks: [
      {
        type: "device-card",
        fields: {
  ...
  // ── 5. Recycle In Progress ────────────────────────────────────────────────────────
  {
    stepId: "Recycle-in-progress",
    greeting: (v) => `Hi ${v.customerName},`,
    bodyText: () =>
      `Good news — Recycle work has started on your item. Our technicians are on it and we'll keep you updated.`,
    blocks: [
      {
        type: "highlight",
        ...
        format: "text",
        accent: "emerald",
        sublineTemplate: "Recycle in progress",
      },
      {
        type: "info-table",
  ...
  // ── 7. Device Returned ───────────────────────────────────────────────────────────
  {
    ...
    greeting: (v) => `Hi ${v.customerName},`,
    bodyText: () =>
      `Your Recycle request has been successfully completed. Here's a summary of your transaction. It's been a pleasure doing business with you!`,
    blocks: [
      {
        type: "highlight",
        label: "Total Payout",

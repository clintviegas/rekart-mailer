...
function LiveEmailPreview({ d }: { d: WorkspaceBranding }) {
  ...
  const compliance = (d.complianceText || "You are receiving this email because you initiated a device repair request on our platform.")
        ...
        <div style={{ backgroundColor: cardBg, borderRadius: `${cardRadius}px`, overflow: "hidden", maxWidth: 480, margin: "0 auto", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}>
          ...
          <div style={{ padding: "20px 24px", backgroundColor: cardBg }}>
            <p style={{ fontFamily: headFont, fontSize: headSz * 0.75, fontWeight: parseInt(d.headingFontWeight || "600"), color: "#0f172a", marginBottom: 8, lineHeight: 1.3 }}>
              Hi Rahul, your repair quote is ready!
            </p>
            <p style={{ fontFamily: bodyFont, fontSize: bodySz * 0.9, color: bodyText, lineHeight: parseFloat(d.lineHeight || "1.65"), marginBottom: 14 }}>
              Great news! We&apos;ve diagnosed your <strong>LG washing machine</strong> and prepared a repair quote. Please review the details below.
            </p>
            ...
            <div style={{ backgroundColor: `${primary}12`, border: `1px solid ${primary}35`, borderRadius: 10, padding: "12px 16px", textAlign: "center", marginBottom: 14 }}>
              <div style={{ fontSize: 9, fontWeight: 700, color: primary, textTransform: "uppercase", letterSpacing: "0.7px", marginBottom: 4 }}>Repair Quote</div>
              <div style={{ fontSize: 28, fontWeight: 800, color: primary, lineHeight: 1 }}>₹ 18,500</div>
              <div style={{ fontSize: 10, color: bodyText, marginTop: 4 }}>Valid for 48 hours · Request ID: RKRP47914</div>
            </div>
            ...
            <div style={{ backgroundColor: "#f8fafc", border: `1px solid ${border}`, borderRadius: 8, overflow: "hidden", fontSize: 11 }}>
              ...
              {[["Request ID", "RKRP47914"], ["Item", "LG washing machine"], ["Condition", "Excellent"], ["Est. range", "₹ 15,000 – 18,500"]].map(([k, v]) => (
...
export function RepairDesignClient() {
      ...
      <div className="shrink-0 border-b border-border bg-card px-5 py-3">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[14px] font-bold text-foreground leading-tight">Repair Email Design</h1>
              <p className="text-[10px] text-muted-foreground">Branding · colors · typography · footer — all Repair emails update automatically</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {isDirty && (
        ...
        <div className="mt-2.5 flex items-center gap-2 rounded-lg border border-blue-200/60 bg-blue-50/60 dark:border-blue-800/30 dark:bg-blue-950/20 px-3 py-1.5">
          ...
          <p className="text-[10px] text-blue-700 dark:text-blue-300">
            Changes here apply to all Repair workflow emails in real-time. The preview on the right updates as you type.
          </p>
        </div>
      </div>
                  ...
                  <>
                    ...
                    <div className="rounded-xl border border-border bg-muted/30 p-4">
                      ...
                      <p style={{ fontFamily: get("bodyFontFamily"), fontSize: parseInt(get("bodyFontSize")||"14",10)*0.85, fontWeight: parseInt(get("bodyFontWeight")||"400"), color: "#475569", lineHeight: parseFloat(get("lineHeight")||"1.65"), marginTop: 6 }}>
                        We&apos;ve diagnosed your LG washing machine and prepared a repair quote. Valid for 48 hours.
                      </p>
                    </div>
                  </>
                )}
                ...
                {active === "compliance" && (
                  <>
                    ...
                    <div>
                      ...
                      <textarea rows={3}
                        placeholder={`© {{year}} Your Company. All rights reserved. You are receiving this email because you initiated a device repair request on our platform.`}

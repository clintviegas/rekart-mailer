...
export default function SupportPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <ActionShell icon="💬" title="Contact Support" subtitle={`Request ${data.requestId}`}>
      <p className="text-sm text-slate-600 mb-5">
        Hi <strong>{data.customerName}</strong>, your support request has been logged. Our team will contact you shortly.
      </p>
